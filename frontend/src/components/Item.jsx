...
const Item = (props) => {
  return (
    <div className="relative bg-white rounded-lg shadow-md overflow-hidden p-1">
      ...
      <div className="absolute top-2 left-2 right-2 flex items-center justify-between">
        ...
        <div className="flex flex-col items-start">
          <h2 className="bg-white rounded-md shadow-md font-mono text-sm font-semibold px-1 p-2">
            {props.username}
          </h2>
        </div>
      </div>
